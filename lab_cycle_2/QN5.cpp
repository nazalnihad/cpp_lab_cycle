...
public:
    championship(std::string your_name, int n1, int n2, int n3) : sports(n1, n2, n3)
    {
        name = your_name;
    }
    void display()
    {
        ...
        football::display(); // displays of different base classes
        cricket::display();
        sports::display();
    }
};
...
int main()
{
    ...
    if (start == 1)
    {
        do
        {
            ...
            std::cin >> total;
            championship a(player_name, total, foot_players, crick_players);
